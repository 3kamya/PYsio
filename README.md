...
| Multi-entry support          | ROM + strength + pain recorded together      |
| Voice parsing UI             | Clear flow: transcript → parsed → apply      |
...
| AI-driven voice-note understanding   | NLP model to interpret natural speech notes |
| Expansion to OT & sports rehab       | Multi-disciplinary rehabilitation platform  |
| Automated recovery anomaly detection | ML flags slow or abnormal progress          |
